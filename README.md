...
A web app that queues custom barcode sequences and displays them on screen at precise intervals. Ideal for stress-testing and validating any workflow that consumes live scanner input.
